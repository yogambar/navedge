...
class UserData extends ChangeNotifier {
  String? _uid; // Add UID here
  String _name = '';
  String? _email;
  // String? _phoneNumber; // Removed phone number field
  String? _age;
  String? _gender;
  String? _dob;
  String? _profileImagePath;
  String _badgeType = ''; // e.g., 'gold', 'silver', 'admin', etc.
  String? _role; // e.g., 'admin', 'user'
  int _loginStreak = 0;
  ...
  bool _isEmailPasswordEnabled = false; // New field
  bool _isGoogleEnabled = false; // New field
  bool _isGitHubEnabled = false; // New field
  bool _isMicrosoftEnabled = false; // New field
  bool _isAppleEnabled = false; // New field
  ...
  // Getters
  String? get uid => _uid; // Getter for UID
  String get name => _name;
  String? get email => _email;
  // String? get phoneNumber => _phoneNumber; // Removed getter
  String? get age => _age;
  ...
  bool get isEmailPasswordEnabled => _isEmailPasswordEnabled; // New getter
  bool get isGoogleEnabled => _isGoogleEnabled; // New getter
  bool get isGitHubEnabled => _isGitHubEnabled; // New getter
  bool get isMicrosoftEnabled => _isMicrosoftEnabled; // New getter
  bool get isAppleEnabled => _isAppleEnabled; // New getter

...
const throwMissingFsModule = (module2) => {
  throw new Error(`Clerk: ${module2} is missing. This is an internal error. Please contact Clerk's support.`);
};
const nodeFsOrThrow = () => {
...
const nodeCwdOrThrow = () => {
  if (!import_safe_node_apis.default.cwd) {
